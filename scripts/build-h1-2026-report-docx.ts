...
const children: any[] = [
  ...
  bulletPoint("Demand concentration in data centers. The tailwind is real, but it ties much of the sector's growth to one source that is constrained by capital, power, and local politics."),
...
children.push(bodyText("The story carries real constraints that operators and investors should weigh: power, water, and rising local opposition. Ohio suspended a data-center tax break amid pressure on tech firms to pay for the power they consume, and activist resistance surfaced in Illinois, Texas, and Arizona."));
children.push(calloutPara("For our clients:", "exposure to data-center demand, direct or through pull-through into HVAC, electrical, structural, and finishing products, is the cleanest growth opportunity in the sector, though it concentrates risk in one capital- and power-intensive source."));
