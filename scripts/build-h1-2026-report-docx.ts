...
children.push(new Table({
  ...
  rows: [
    trendTableHeader(),
    trendRow("Interest & Mortgage Rates", "Fed held at 3.50–3.75% (4th hold Jun 17), then turned hawkish — hike now likelier than cut; 30-yr fixed volatile in the low-6s (6.46% to 6.20% to 6.36%).", "Negative"),
...
children.push(caseStudy("steel cost & commodity-volatility mitigation", "For Array Technologies, AV assessed steel-sourcing maturity against best-in-class and benchmarked spend across its network of 27+ mill and service-center relationships, then quantified a roadmap: $79–114/ST in steel-cost reduction by consolidating flat steel onto a directed-buy program, a further $20–40/ST by reshaping the sourcing footprint, and up to ±$26M in gross-margin-variance reduction through indexation.", "real AV engagement"));
children.push(flagPara("Names Array Technologies (client match tentative). Before external release, confirm client-disclosure permission or anonymize (e.g., \"a steel-intensive equipment manufacturer\"). The $79–114/ST and ±$26M figures are not yet traced to a source deck — verify before use. Internal review draft only."));
...
children.push(caseStudy("capturing a new growth segment", "For ASSA ABLOY, targeting a new, higher-value end-user segment, AV built a go-to-market strategy segment-by-segment: mapping the buying center, criteria, and process; defining the sales-rep profile and value-added support model; and producing a sized market-opportunity assessment and roll-out plan. The same playbook applies directly to capturing data-center demand: identify the highest-value programs, then build the commercial readiness to win them.", "real AV engagement"));
children.push(flagPara("Names ASSA ABLOY. Before external release, confirm client-disclosure permission or anonymize (e.g., \"a building-products manufacturer\"). Internal review draft only."));
...
const scoreRows: Array<[string, string, V, string]> = [
  ["Rates ease → residential recovers", "Held all half (4th hold Jun 17); Fed turned hawkish, hike now likelier than cut", "miss", "Plan residential off rate volatility, not Fed-cut timing; the recovery is now a 2027 case, so hold capacity for a later, sharper rebound rather than a smooth 2026 ramp."],
...
children.push(bulletPoint("Steel cost & commodity-volatility mitigation (see §4) — Array Technologies; directed-buy and indexation roadmap; $79–114/ST steel-cost reduction and up to ±$26M margin-variance reduction."));
children.push(bulletPoint("New-segment growth capture (see §5) — ASSA ABLOY; go-to-market strategy by end-user segment; sized market opportunity and roll-out plan."));
