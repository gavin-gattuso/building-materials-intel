...
import { buildSmartSearchResponse, buildSearchContext, buildSourceList, SYSTEM_PROMPT_PREFIX } from "../lib/chat";
...
// buildSmartSearchResponse and buildSearchContext imported from lib/chat.ts
...
async function buildAIResponse(message: string, history: any[]) {
  ...
  return { mode: "ai", answer: text, sources: buildSourceList(results) };
}
