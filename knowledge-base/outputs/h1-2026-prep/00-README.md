...
1. **⚠ All four case studies now NAME REAL CLIENTS — MUST ANONYMIZE BEFORE EXTERNAL RELEASE.** De-anonymized for internal validation (2026-06-15, from Glean source-tracing): **Array Technologies** (§4③ steel), **ASSA ABLOY** (§5 GTM), **Heidelberg Materials** (§6 procurement, case 777-01-1, Nate Cory), **Piab** (§6 post-deal, an IT-vendor outsourcing negotiation). Anonymize all four before any external distribution. Flagged loudly in the draft (cover draft-bar, §4③/§5/§6 case studies, §9 note) across manuscript, PDF, and docx. **Two figures still need verification before use:** Heidelberg's $2.8M/$7.5M/$150.9M (source decks show $5.75M/$6.0M variants) and the steel $79–114/ST / ±$26M (not yet traced to a source deck; Array Technologies is a tentative match — owner Alex Curiel). Still open from Glean: Piab's PE sponsor and the §5/§6 AV engagement owners. *(The separate §6 mention of Heidelberg's public Maas Group acquisition is a public M&A fact and does not need anonymizing.)*
