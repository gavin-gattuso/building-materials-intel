...
1. **⚠ Heidelberg Materials — MUST ANONYMIZE BEFORE EXTERNAL RELEASE.** Stays named for internal review (author decision 2026-06-12), but the §6 procurement case and its §9 reference name a real client. Before any external distribution, confirm client-disclosure permission or replace with "a top-three global cement producer." This is now flagged loudly in the draft itself (cover draft-bar, §6 case study, §9 note) across the manuscript, PDF, and docx. *(The separate §6 mention of Heidelberg's public Maas Group acquisition is a public M&A fact and does not need anonymizing.)*
