...
// Company matching: matchCompanies() and the 39-company COMPANY_MATCH_RULES
// table live in lib/company-match.ts (imported above). Removed the in-file
// duplicate on 2026-05-12 — sole source of truth is now the lib.
